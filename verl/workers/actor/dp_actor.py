...
from verl.trainer.ppo.core_algos import agg_loss, compute_policy_loss, kl_penalty, compute_m2po_policy_loss
            ...
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if self.config.get('use_m2po_loss', False):
                        ...
                        print('>>> Use ppo loss')
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower, ratio_stats = compute_policy_loss(
                            old_log_prob=old_log_prob,
                            log_prob=log_prob,
                            advantages=advantages,
                            response_mask=response_mask,
