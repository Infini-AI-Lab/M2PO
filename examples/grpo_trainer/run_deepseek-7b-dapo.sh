...
experiment_name=deepseek_7b_dapo_train
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/checkpoints/beidchen/checkpoints/checkpoints/qwen3_models/DeepSeek-R1-Distill-Qwen-7B \
